...
int main()
{
    ...
    while(opt>=1 && opt <=5){
        ...
        case 1:
            ...
            Q1.hSize = (int)size/ LOAD_FACTOR; ///how many slots
            Q1.nSize = 0;

            Q1.Table = (HashTableNode *) malloc(sizeof(HashTableNode)*(Q1.hSize)); ///array of LL
...
int HashDelete(HashTable* Q1Ptr, int key)
{
   ...
   {
       if(temp == Q1Ptr->Table[index].head) //first node in LL
       {
           cur = temp->next;
           temp->pre = NULL;
