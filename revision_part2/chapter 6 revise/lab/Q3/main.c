...
int main()
{
    ...
    while(opt>=1 && opt <=4){
        ...
        case 1:
            ...
            Q3Hash.hSize = (int)size/ LOAD_FACTOR; //size of array of pointers to LL
            Q3Hash.nSize = 0;
...
ListNode* HashSearch(HashTable Q3Hash, int key)
{
    ...
    if(Q3Hash.Table[index].head == NULL)
    {
        return NULL; //LL empty thus key not there
    }
    else
    {
        ...
        return NULL; //go through LL no key found return NUll
    }
}
